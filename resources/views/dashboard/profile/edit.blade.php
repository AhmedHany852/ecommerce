...
@section('content')
    ...
    <form action="{{ route('profile.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="col-md-6">
                <x-form.input name="birth_date" type="date" label="Birthday" :value="$user->profile->birthday" />
            </div>
            <div class="col-md-6">
        ...
        <div class="form-row">
            ...
            <div class="col-md-4">
                <x-form.select name="locale" :options="$locale" label="Languages" :selected="$user->profile->locale" />
            </div>
        </div>
